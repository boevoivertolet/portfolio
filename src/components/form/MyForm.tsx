...
import styles from '../../common/styles//ContactsPage.module.scss'
                ...
                <div className={styles.formData}>
                    <div className={styles.nameEmailPhone}>
                        <div className={styles.inputGroup}>
                            ...
                            />
                            {errors.fullName && (
                                <span className={errors.fullName ? styles.p__error : ''}>
                                    <i className="fa-solid fa-triangle-exclamation"></i>
                                    {errors.fullName?.message ? errors.fullName.message : '1'}
                                </span>
                            )}
                        </div>
                        <div className={styles.inputGroup}>
                            ...
                            />
                            {errors.email && (
                                <span className={errors.email ? styles.p__error : ''}>
                                    <i className="fa-solid fa-triangle-exclamation"></i>
                        ...
                        <div className={styles.inputGroup}>
                            ...
                            />
                            {errors.phone && (
                                <span className={errors.phone ? styles.p__error : ''}>
                                    <i className="fa-solid fa-triangle-exclamation"></i>
                    ...
                    <div className={styles.textareaGroup}>
                        ...
                        <textarea
                            className={
                                errors.message
                                    ? `${styles.formTextarea + ' ' + styles.formInput__error}`
                                    : styles.formTextarea
                            }
                            id={'message'}
