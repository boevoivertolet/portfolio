...
export const MyWorks = () => {
    ...
    let descriptionTodo = 'Учебный проект, который я делал, когда обучался в "it-incubatore". В какой-то степени скопирован функционал "Trello" Создание списка дел, удаление, обновление. Весь на хуках. От  useState до useSelector, useMemo, useDispatch, а так же кастомные хуки. '
