...
export const MyWorks = () => {
    ...
    let descriptionCasecook = 'Довольно объемная реализация социальной сети. От верстки, до санок, запросов на сервер и обработки ответов. Проект на классах с элементами хуков.(В разработке) '
    let descriptionTodo = ' Домашнее "Trello" =). Создание списка дел, удаление, обновление. Реализовано  на хуках. От  useState до useSelector, useMemo, useDispatch, а так же кастомные хуки. (В разработке) '
    let descriptionCounter = 'Реализация счётчика по возрастающей сложности. От простейшего через локальный стейт до применения Redux.'
